...
export default {
  ...
  mounted() {
    this.fetchReviews();
    this.fetchCoffees();
    this.fetchUsers(); // Preuzimamo sve korisnike da bi mogli da prikazemo njihova imena
  ...
  methods: {
    ...mapActions([
      "fetchReviews",
      "fetchCoffees",
      "fetchUsers", // Dodajemo akciju za preuzimanje korisnika
      "createReview",
      "deleteReview",
    ]),

    // Metoda za preuzimanje imena kafe
    ...
    // Metoda za prikazivanje imena korisnika
    getUserName(userId) {
    ...
    submitReview() {
      ...
      this.createReview(reviewData); // Kreiramo novu recenziju sa potrebnim podacima
    },
